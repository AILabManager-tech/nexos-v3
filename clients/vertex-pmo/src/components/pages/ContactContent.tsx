          ...
          <div className="grid gap-12 md:grid-cols-5">
            ...
            <AnimatedSection direction="left" className="md:col-span-3">
              <form className="card-elevated space-y-5" onSubmit={handleSubmit}>
                ...
                <p className="text-sm text-slate-500">{t("form.response_time")}</p>
              </form>
            </AnimatedSection>
            ...
            <AnimatedSection direction="right" delay={0.2} className="md:col-span-2">
              <div className="card-elevated !bg-cobalt-600 !border-cobalt-700 text-white">
                <h3 className="mb-6 text-cobalt-100 text-xl font-heading font-bold">
                  {t("info.title")}
                </h3>
                <div className="space-y-6">
                  <div className="flex items-start gap-3">
                    <Mail className="h-5 w-5 text-cobalt-200 mt-0.5 shrink-0" />
                    <div>
                      <p className="text-sm font-medium text-cobalt-200">{t("info.email_label")}</p>
                  ...
                  <div className="flex items-start gap-3">
                    <Phone className="h-5 w-5 text-cobalt-200 mt-0.5 shrink-0" />
                    <div>
                      <p className="text-sm font-medium text-cobalt-200">{t("info.phone_label")}</p>
                  ...
                  <div className="flex items-start gap-3">
                    <MapPin className="h-5 w-5 text-cobalt-200 mt-0.5 shrink-0" />
                    <div>
                      <p className="text-sm font-medium text-cobalt-200">{t("info.location_label")}</p>
                      <p className="text-cobalt-100">{t("info.location")}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <svg className="h-5 w-5 text-cobalt-200 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                    </svg>
                    <div>
                      <p className="text-sm font-medium text-cobalt-200">{t("info.linkedin")}</p>
                      <a
